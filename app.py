...
# Liste de toutes les pages sous forme de fonctions
pages = ["Accueil", "Analyse Temporelle", "Analyse de Sévérité", "Analyse par Localisation", "Analyse Météo", "Conclusion"]
...
# Affichage du numéro de page et barre de progression
st.markdown(f"### Page {st.session_state.page_index + 1} / {len(pages)}")
progress = (st.session_state.page_index + 1) / len(pages)
st.progress(progress)
st.divider()

# Créer un conteneur vide pour l'effet de transition
page_container = st.empty()

# Ensuite, on remplit le conteneur
with page_container.container():
    with st.spinner("Chargement de la page..."):
        import time
        time.sleep(0.3)  # petit délai pour effet storytelling
        # --- PAGE ACCUEIL ---
        ...
        elif current_page == "Analyse Météo":
        ...
        elif current_page == "Analyse de Sévérité":
        ...
        elif current_page == "Analyse Temporelle":
        ...
        elif current_page == "Analyse par Localisation":
